import { DEFAULT_INDEX, LAST_HOURS_DAY, LAST_MINUTES_DAY, LAST_SECONDS_DAY, MIN_DATE, MIN_YEAR, THE_COFFEE_HOUSE } from "~/constants/AppConstant";
...
// export const outputData = (data, fucError) => {

//     if (typeof fucError !== 'function') {
